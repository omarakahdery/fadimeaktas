...
export const Footer = () => {
  return (
    ...
    <footer className="footer border-top pt-5 pb-4">
      <div className="container-fluid pt-sm-2 pt-md-3 pt-lg-4">
        ...
        <div className="d-flex justify-content-center justify-content-lg-start gap-2 mt-n2 mt-md-0">
          <a className="btn btn-icon fs-base btn-outline-secondary border-0" href="#!" data-bs-toggle="tooltip"
